...
import { Home, FileText, MessageSquare, Mail, ShieldAlert, Briefcase, Heart, ClipboardList, DollarSign, Users, Crown, Linkedin, Gift, User, Network, Shield, FilePen, Target, GraduationCap, Tag } from "lucide-react";
...
const navItems = [
  ...
  { path: "/salary-negotiation", icon: DollarSign, label: "Salary" },
  { path: "/success-stories", icon: Users, label: "Stories" },
  { path: "/bonus-scripts", icon: Crown, label: "Premium" },
  { path: "/linkedin-guide", icon: Linkedin, label: "LinkedIn" },
